        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Pi of Emergency Fund</h6>
                </div>
                <div class="card-body">
                    <p><b>You are applying under Emergency Fund for <u><?php echo $university;?></u> situated at <u><?php echo $address;?></u></b></p>
                    <h6 class="m-0 font-weight-bold text-primary">Eligibility Criteria:</h6>
                    The university must be a registered educational institution and have a proven track record of providing quality education to its students. The university must have been a PEF Partner for 3 years and has passed 2 QATs conducted by the Punjab Education Foundation. Last QAT failure universities are eligible for the emergency fund program.
                    <br><br>
                    <h6 class="m-0 font-weight-bold text-primary">Application Process:</h6>
                    The university must submit an online application to Pi, which should include the following information:
                    <br><br>
                    1. Details of the emergency situation that has affected the university.<br>
                    2. A detailed plan on how the funds will be utilized to support the recovery of the university.<br>
                    3. The expected impact of the funds on the university and its students.<br>
                    4. Contact information of the university and the person responsible for managing the funds.
                    <br><br>
                    <h6 class="m-0 font-weight-bold text-primary">Needs Assessment:</h6>
                    Our team will conduct an assessment of the university's needs to determine the amount of funds required to support the recovery efforts. The needs assessment will take into consideration the following factors:
                    <br><br>
                    ...
                    3. The resources available to the university to support the recovery efforts.
                    <br><br>
                    <h6 class="m-0 font-weight-bold text-primary">Funding Approval:</h6>
                    Pi's core committee will review the request and, if approved, will provide the required funds to the university to promote quality education.<br><br>
                    <h6 class="m-0 font-weight-bold text-primary">Monitoring and Evaluation:</h6>
                    Our team will conduct periodic monitoring visits to the university to ensure that the funds are being utilized effectively and efficiently.<br><br>
